        ...
        <table cellspacing="0">
            <thead>
                <tr>
                    ...
                    <td>状态</td>
                    <td>操作<font size=6 color='#F16522'>${sendMessage}</font></td>
                    <td>
                ...
                <form method="post" name="sendForm">
				    <c:forEach var="order" items="${ orderList}">
				        <tr>
				            ...
				            <td><a href="adminSendOrderServlet?orderId=${order.orderId}&pageOffset=${orderPager.pageOffset}&pageSize=${orderPager.pageSize}">发货</a></td>
				    </c:forEach>
				    	</tr>
				</form>
            </tbody>
