...
<div class="tablewrapper">
    ...
    <div class="tablecontent">
    	<div class="option-area">
            ...
            <button class="btn-default" onclick="searchOrder(2)">查询</button>
                ...
                <form method="post" name="deleteForm">
                    <c:forEach var="order" items="${ orderList}">
                        <tr>
                            ...
                            <td><a href="javascript:void(0);" onclick="setUpdateOrderInfo(${order.orderId },'getOrderPagerServlet') ">修改</a></td>
